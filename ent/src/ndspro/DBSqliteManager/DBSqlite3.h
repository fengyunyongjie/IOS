...
//商业版新代码
#define CreateDownList @"CREATE TABLE IF NOT EXISTS DownList(d_id INTEGER PRIMARY KEY AUTOINCREMENT,d_name TEXT,d_state INTEGER,d_baseUrl TEXT,d_webUrl TEXT,,d_downSize INTEGERd_baseUrl TEXT,D_ure_id TEXT)"
