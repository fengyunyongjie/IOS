...
- (void)denyAccess {
    ...
    {
        _failedAttemptLabel.text = [NSString stringWithFormat: @"还可以尝试%i次", _failedAttempts];
        UIAlertView *alertView = [[UIAlertView alloc] initWithTitle:@"提示" message:@"你还可以尝试最后一次解锁，若依然错误，将会退回登录界面" delegate:nil cancelButtonTitle:@"知道了" otherButtonTitles:nil, nil];
        [alertView show];
    }
	else
    {
