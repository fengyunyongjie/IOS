...
/// number of times).
/// @see mutex
class EXTERNCLASS  recursive_mutex {
  public:
    /// Constructor.
    recursive_mutex()
    {
...
/// }
/// @endcode
class EXTERNCLASS  condition_variable {
  public:
    /// Constructor.
#if defined(_TTHREAD_WIN32_)
    condition_variable();
