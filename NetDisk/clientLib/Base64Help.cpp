...
void Base64Help::_enBase64Help(unsigned char chasc[3],unsigned char chuue[4]) 
...
void Base64Help::_deBase64Help(unsigned char chuue[4],unsigned char chasc[3]) { 
...
string Base64Help::enBase64( const char* inbuf, size_t inbufLen ) { 
...
string Base64Help::enBase64( const string &inbuf) 

{ 

	return Base64Help::enBase64( inbuf.c_str(), inbuf.size() ); 

}  



int Base64Help::deBase64( string src, char* outbuf ) {  
...
string Base64Help::deBase64( string src) 
