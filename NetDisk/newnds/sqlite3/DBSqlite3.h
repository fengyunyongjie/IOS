...
#define CreateUserinfoTable @"CREATE TABLE IF NOT EXISTS Userinfo(U_ID INTEGER PRIMARY KEY AUTOINCREMENT,ISTRUE INTEGER,KEY TEXT,DESCRIPT TEXT,F_ID INTEGER)"
