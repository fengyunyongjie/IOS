...
{
    [self setImageWithURL:url placeholderImage:placeholder options:(SDWebImageOptions)0];
}
...
{
    [self setBackgroundImageWithURL:url placeholderImage:placeholder options:(SDWebImageOptions)0];
}
...
{
    [self setBackgroundImageWithURL:url placeholderImage:placeholder options:(SDWebImageOptions)0 success:success failure:failure];
}
